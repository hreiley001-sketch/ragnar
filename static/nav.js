...
(function () {
  ...
  function initConcierge() {
    ...
    function personalize(text) {
      ...
      if (/\b(dark|darker|midnight|black|night)\b/.test(low)) theme.theme_bg = "#03060b";
      else if (/\b(light|lighter|bright|brighter|white|day)\b/.test(low)) theme.theme_bg = "#0b1420";

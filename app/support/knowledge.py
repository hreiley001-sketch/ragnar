...
SEED_ARTICLES: list[dict] = [
    ...
    },
    {
        ...
        "body": (
            ...
            "Connect Stripe Express to receive payouts. Founding Sellers get a 4% "
            "introductory platform fee on their first $250 in sales, then the "
            "standard 5% like everyone else. Non-founding sellers pay the flat 5% "
            "standard fee from day one. Structured, grading-aware listings are "
            "required."
        ),
        "rules": {},
    },
    {
        ...
        "body": (
            "RAGNAR's standard platform fee is a flat 5% for every seller. Our "
            "founders program, the Founding 250, get an introductory 4% rate on "
            "their first $250 in sales, then 5% like everyone else — no time "
            "window, just a simple dollar cap. Payment processing is pass-through "
            "(roughly 2.9% + $0.30). There are no insertion fees."
        ),
        "rules": {},
    },
    {

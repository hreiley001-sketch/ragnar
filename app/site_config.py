...
SITE_FIELDS: list[dict] = [
    ...
    {"key": "perk1_title", "label": "Perk 1 title", "type": "text", "group": "Homepage perks", "default": "Keep 95%"},
    {"key": "perk1_desc", "label": "Perk 1 detail", "type": "text", "group": "Homepage perks", "default": "One flat 5% platform fee. No tiers, no surprises, no fine print."},
    {"key": "perk2_title", "label": "Perk 2 title", "type": "text", "group": "Homepage perks", "default": "Founding 250 status"},
    {"key": "perk2_desc", "label": "Perk 2 detail", "type": "text", "group": "Homepage perks", "default": "A permanent badge for the first 250 sellers who built the vault early."},
